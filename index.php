		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					<a class="nav-item nav-link active" href="#welcome">Welcome <span class="sr-only">(current)</span></a>
					<a class="nav-item nav-link" href="#photos">Memories</a>
					<a class="nav-item nav-link" href="#the-rest">The rest of the story</a>
					<a class="nav-item nav-link" href="#social-media">Social Media</a>
					<a class="nav-item nav-link" href="#contact-us" tabindex="-1" aria-disabled="true">Contact Us</a>
				</div>
			</div>
		</nav>
						...
						<ol class="carousel-indicators">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100" src="images/CallySummer2018.jpeg" alt="Baby Cally!">
								</div>
				...
				<div class="col-md-10">
					<h2 id="social-media">You can follow our adventures too!</h2>
						<p>Add us on social media! </p>
							...
							<div>
								<a class="twitter-timeline" href="https://twitter.com/ClawshankR?ref_src=twsrc%5Etfw">Tweets by ClawshankR</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
							</div>
		</div>
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-10">
					<h2 id="contact-us">Do you have a treat for us? Contact us!</h2>
				<!-- FORM START -->
...
<br>
					<!-- reCAPTCHA -->
					<div class="g-recaptcha" data-sitekey="6LfFCLMUAAAAAN4tNLkZGmfqwncIGfCFOhmde9Ds">
					</div>
<br>
<br>
